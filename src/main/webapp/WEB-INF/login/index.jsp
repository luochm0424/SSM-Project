		...
		<ul class="layui-nav right">
			<li class="layui-nav-item"><a href="javascript:;"><shiro:principal/></a>
				<dl class="layui-nav-child">
					...
					<dd>
						<a href="/loginController/logout.do">退出登录</a>
					</dd>
				</dl></li>
	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
				...
				<!-- 示例：这是一个下拉菜单 -->
				<li><a href="javascript:;"> <i class="iconfont">&#xe6b8;</i> <cite>系统管理</cite> <i
				...
				<!-- 这组下拉菜单结束 -->
				<shiro:hasPermission name="gongwen">
				<!-- 这是另一组菜单示例 -->
				...
				<cite>公文管理</cite> <i
					...
					<ul class="sub-menu">
						<li><a _href="roleController/toUserRole.do"> <i class="iconfont">&#xe6a7;</i> <cite>文件管理</cite>
						</a></li>
					</ul></li>
				</shiro:hasPermission>
				<!-- 示例结束 -->
					<!-- 这是另一组菜单示例 -->
				<shiro:hasPermission name="email">
				...
				<cite>邮件管理</cite> <i
					...
					<ul class="sub-menu">
						<li><a _href="propertyController/showAllProperty.do"> <i class="iconfont">&#xe6a7;</i> <cite>收件箱</cite>
						</a></li>
						<li><a _href="propertyController/showBorrowreturn.do"> <i class="iconfont">&#xe6a7;</i> <cite>发件箱</cite>
						</a></li>
					</ul></li>
				</shiro:hasPermission>
				<!-- 示例结束 -->
		...
		<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<iframe src='/loginController/showWelcome.do' frameborder="0" scrolling="yes"
